...
import TheoryObject (addParamsToThy, addParamsToDiffThy)
...
loadClosedThyWfReport as inFile = do
    ...
    -- return closed theory
    closeThyWithMaude transSig as openThy (addParamsToThy "prove" lemmaArgsNames transThy)
...
loadClosedDiffThyWfReport as inFile = do
    ...
    reportWellformedness prefix (hasQuitOnWarning as) errors
    -- return closed theory
    closeDiffThyWithMaude sig as (addParamsToDiffThy "prove" lemmaArgsNames thy1)
